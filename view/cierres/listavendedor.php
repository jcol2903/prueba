<div class="col-lg-12 mb-4">
  <div class="card">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-success">Cierres por Vendedor</h6>
    </div>
    <?php 
      include"../../config.php";
    ...
    <div class="table-responsive">
      ...
      <table class="table align-items-center table-flush">
        ...
        <tbody>
          <?php include"../../controller/mdl_cierres/lista_apuestas_vendedores.php" ?>
        </tbody>
      </table>
    </div>
    <div class="table-responsive">
      ...
      <table class="table align-items-center table-flush">
        ...
        <tbody>
          <?php include"../../controller/mdl_cierres/lista_ganadores_vendedores.php" ?>
        </tbody>
      </table>
    </div>
  </div>
