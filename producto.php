...
<div class="d-sm-flex justify-content-between ml-4 mb-4">
  <a href="index.php" class="btn btn-danger" style="color:white; cursor:pointer;">Lista Productos</a>
</div>
  ...
  <div class=" row">
        ...
        <form onsubmit="return false;" id="formulario">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="fecha" aria-describedby="" required>                 
            </div>
            <div class="form-group">
    ...
    <div class="col-lg-6 pt-3">
            <div class="form-group">
              ...
              <input type="file" class="form-control" name="nombre" aria-describedby="" required>                 
            </div>
        </div>
  </div>
        </form>
